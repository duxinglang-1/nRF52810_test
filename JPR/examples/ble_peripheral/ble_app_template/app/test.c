...
//	NRF_LOG_INFO("UTC_TIME_SECONDS: %d \n",UTC_TIME_SECONDS);
...
uint32_t system_time_init(void)
{
	...
	err_code = app_timer_create(&UTC_TIME_id,APP_TIMER_MODE_REPEATED,UTC_timer_handler); //UTC_timer_handler
...
//===========================================================================
    ...
    static void test_encrypt_cbc(void)//feng here
    {
